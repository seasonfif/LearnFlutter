...
class ScaledLayout extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return ScaledLayoutState();
  }
}

class ScaledLayoutState extends State<ScaledLayout>{
  static const double DEFAULT_WIDTH = 320;
  static const double DEFAULT_HEIGHT = 180;
    ...
    return Stack(
      children: <Widget>[
        ...
        Positioned(
          child:
          GestureDetector(
            child:VideoWidget(width: _width, height: _height,),
            onScaleEnd: scaleEnd,
